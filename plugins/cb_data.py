...
async def doc(bot,update):
     ...
     ms = await update.message.edit("⚠️__**𝙿𝚕𝚎𝚊𝚜𝚎 𝚠𝚊𝚒𝚝.....**__\n__𝚃𝚛𝚢𝚒𝚗𝚐 𝚃𝚘 𝙳𝚘𝚠𝚗𝚕𝚘𝚊𝚍 ...__")
     c_time = time.time()
     try:
     	path = await bot.download_media(message = file, progress=progress_for_pyrogram,progress_args=( "\n⚠️__**𝙿𝚕𝚎𝚊𝚜𝚎 𝚠𝚊𝚒𝚝....**__\n\n😈 **𝚃𝚛𝚢𝚒𝚗𝚐 𝚃𝚘 𝙳𝚘𝚠𝚗𝚕𝚘𝚊𝚍 ...**",  ms, c_time   ))
     ...
     await ms.edit("⚠️__**𝙿𝚕𝚎𝚊𝚜𝚎 𝚠𝚊𝚒𝚝....**__\n__𝚃𝚛𝚢𝚒𝚗𝚐 𝚃𝚘 𝚄𝚙𝚕𝚘𝚊𝚍....__")
     c_time = time.time() 
     try:
        if type == "document":
           await bot.send_document(
		    update.message.chat.id,
                    ...
                    progress_args=( "⚠️__**𝙿𝚕𝚎𝚊𝚜𝚎 𝚠𝚊𝚒𝚝....**__\n__𝚃𝚛𝚢𝚒𝚗𝚐 𝚃𝚘 𝚄𝚙𝚕𝚘𝚊𝚍....__",  ms, c_time   ))
        elif type == "video": 
